function [dataM,dataS,dataA,txtA,dataD,dataDmax,dataDidx]=conn_qaplotsexplore_readfiles(files_jpg,files_txt,in, keeprawdata, dogui);
...
if any(conn_server('util_isremotefile',files_jpg)), 
    ...
    [dataM,dataS,dataA,txtA,dataD,dataDmax,dataDidx]=conn_server('run',mfilename,conn_server('util_localfile',files_jpg),conn_server('util_localfile',files_txt), in, false, false); 
