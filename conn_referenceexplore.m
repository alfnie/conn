...
dlg.handles.cb1=uicontrol('style','checkbox','units','norm','position',[.025,.925,.20,.05],'backgroundcolor',bgc,'foregroundcolor','k','horizontalalignment','left','value',guifields.include(1),'string','<HTML>Describe <b>Preprocessing</b> steps</HTML>','fontweight','normal','fontsize',9+font_offset,'callback',{@conn_referenceexplore_update,'preprocessing'},'interruptible','off');
dlg.handles.cb2=uicontrol('style','checkbox','units','norm','position',[.275,.925,.20,.05],'backgroundcolor',bgc,'foregroundcolor','k','horizontalalignment','left','value',guifields.include(2),'string','<HTML>Describe <b>Denoising (1st-level)</b> steps</HTML>','fontweight','normal','fontsize',9+font_offset,'callback',{@conn_referenceexplore_update,'denoising'},'interruptible','off');
dlg.handles.cb3=uicontrol('style','checkbox','units','norm','position',[.525,.925,.20,.05],'backgroundcolor',bgc,'foregroundcolor','k','horizontalalignment','left','value',guifields.include(3),'string','<HTML>Describe <b>Analyses (1st-level)</b> steps</HTML>','fontweight','normal','fontsize',9+font_offset,'callback',{@conn_referenceexplore_update,'firstlevel'},'interruptible','off');
dlg.handles.cb4=uicontrol('style','checkbox','units','norm','position',[.775,.925,.20,.05],'backgroundcolor',bgc,'foregroundcolor','k','horizontalalignment','left','value',guifields.include(4),'string','<HTML>Describe <b>Results (2nd-level)</b> steps</HTML>','fontweight','normal','fontsize',9+font_offset,'callback',{@conn_referenceexplore_update,'secondlevel'},'interruptible','off');
...
dlg.handles.preproclog=uicontrol('style','popupmenu','units','norm','position',[.025,.75,.20,.13],'max',1,'backgroundcolor',bgc,'foregroundcolor','k','string',[{'<HTML><em>select preprocessing log date</em></HTML>'},options.preproclog_text],'value',1+guifields.preproclog,'tooltipstring','Select a preprocessing pipeline to include in the methods description','fontsize',9+font_offset,'callback',{@conn_referenceexplore_update,'preprocessing'},'interruptible','off');
