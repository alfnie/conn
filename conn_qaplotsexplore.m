                            ...
                            if ~isempty(dlg.results_info)&&isstruct(dlg.results_info{1}),
                                if isfield(dlg.results_info{1},'IntersectionBefore')
                                    if isfield(dlg.results_info{1},'PercentSignificantBefore')
                                        text(-.95,dlg.plothistinfo2*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('mean=%.2f sd=%.2f (%.1f%% overlap with NH)',dlg.results_info{1}.MeanAfter,dlg.results_info{1}.StdAfter,100*dlg.results_info{1}.IntersectionAfter),sprintf('%.1f%% edges with p<.05, %.1f%% edges with q<.05',100*dlg.results_info{1}.PercentSignificantAfter(1),100*dlg.results_info{1}.PercentSignificantAfter(2))},'horizontalalignment','left','fontsize',5+font_offset,'parent',dlg.handles.hax);
                                        text(-.95,dlg.plothistinfo2+(dlg.plothistinfo3-dlg.plothistinfo2)*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('mean=%.2f sd=%.2f (%.1f%% overlap with NH)',dlg.results_info{1}.MeanBefore,dlg.results_info{1}.StdBefore,100*dlg.results_info{1}.IntersectionBefore),sprintf('%.1f%% edges with p<.05, %.1f%% edges with q<.05',100*dlg.results_info{1}.PercentSignificantBefore(1),100*dlg.results_info{1}.PercentSignificantBefore(2))},'horizontalalignment','left','fontsize',5+font_offset,'parent',dlg.handles.hax);
                                    else
                                        text(-.95,dlg.plothistinfo2*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('mean=%.2f sd=%.2f (%.1f%% overlap with NH)',dlg.results_info{1}.MeanAfter,dlg.results_info{1}.StdAfter,100*dlg.results_info{1}.IntersectionAfter)},'horizontalalignment','left','fontsize',5+font_offset,'parent',dlg.handles.hax);
