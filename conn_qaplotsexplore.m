                ...
                switch(dlg.uanalysestype(dlg.ianalysis))
                    ...
                    case {2,3,4} % QA_DENOISE
                            ...
                            if ~isempty(dlg.results_info)&&isstruct(dlg.results_info{1}),
                                if isfield(dlg.results_info{1},'IntersectionBefore')
                                    if isfield(dlg.results_info{1},'PercentSignificantBefore')
                                        text(-.95,dlg.plothistinfo2*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('%.1f%% overlap with NH (mean=%.2f sd=%.2f)',100*dlg.results_info{1}.IntersectionAfter,dlg.results_info{1}.MeanAfter,dlg.results_info{1}.StdAfter),sprintf('%.1f%% edges with p<.05, %.1f%% edges with q<.05',100*dlg.results_info{1}.PercentSignificantAfter(1),100*dlg.results_info{1}.PercentSignificantAfter(2))},'horizontalalignment','left','fontsize',7+font_offset,'parent',dlg.handles.hax);
                                        text(-.95,dlg.plothistinfo2+(dlg.plothistinfo3-dlg.plothistinfo2)*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('%.1f%% overlap with NH (mean=%.2f sd=%.2f)',100*dlg.results_info{1}.IntersectionBefore,dlg.results_info{1}.MeanBefore,dlg.results_info{1}.StdBefore),sprintf('%.1f%% edges with p<.05, %.1f%% edges with q<.05',100*dlg.results_info{1}.PercentSignificantBefore(1),100*dlg.results_info{1}.PercentSignificantBefore(2))},'horizontalalignment','left','fontsize',7+font_offset,'parent',dlg.handles.hax);
                                    else
                                        text(-.95,dlg.plothistinfo2*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('mean=%.2f sd=%.2f (%.1f%% overlap with NH)',dlg.results_info{1}.MeanAfter,dlg.results_info{1}.StdAfter,100*dlg.results_info{1}.IntersectionAfter)},'horizontalalignment','left','fontsize',7+font_offset,'parent',dlg.handles.hax);
                                        text(-.95,dlg.plothistinfo2+(dlg.plothistinfo3-dlg.plothistinfo2)*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('mean=%.2f sd=%.2f (%.1f%% overlap with NH)',dlg.results_info{1}.MeanBefore,dlg.results_info{1}.StdBefore,100*dlg.results_info{1}.IntersectionBefore)},'horizontalalignment','left','fontsize',7+font_offset,'parent',dlg.handles.hax);
                                    end
                        ...
                        elseif ~isempty(dlg.results_info)&&isstruct(dlg.results_info{1})&&isfield(dlg.results_info{1},'IntersectionBefore')&&isfield(dlg.results_info{1},'PercentSignificantBefore')
                            text(-.95,dlg.plothistinfo2*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('%.1f%% overlap with NH (combined %d measures)',100*min(cellfun(@(x)x.IntersectionAfter,dlg.results_info)),numel(in))},'horizontalalignment','left','fontsize',8+font_offset,'parent',dlg.handles.hax);
                            text(-.95,dlg.plothistinfo2+(dlg.plothistinfo3-dlg.plothistinfo2)*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('%.1f%% overlap with NH (combined %d measures)',100*min(cellfun(@(x)x.IntersectionBefore,dlg.results_info)),numel(in))},'horizontalalignment','left','fontsize',8+font_offset,'parent',dlg.handles.hax);
                            %text(-.95,dlg.plothistinfo2*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('combined %.1f%% overlap with NH',100*sum(minshow1)),sprintf('mean=%.2f std=%.2f',mean(cellfun(@(x)x.MeanAfter,dlg.results_info)),mean(cellfun(@(x)x.StdAfter,dlg.results_info)))},'horizontalalignment','left','fontsize',5+font_offset,'parent',dlg.handles.hax);
                            %text(-.95,dlg.plothistinfo2+(dlg.plothistinfo3-dlg.plothistinfo2)*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('combined %.1f%% overlap with NH',100*sum(minshow2)),sprintf('mean=%.2f sd=%.2f',mean(cellfun(@(x)x.MeanBefore,dlg.results_info)),mean(cellfun(@(x)x.StdBefore,dlg.results_info)))},'horizontalalignment','left','fontsize',5+font_offset,'parent',dlg.handles.hax);
                        ...
                        elseif ~isempty(dlg.results_info)&&isfield(dlg.results_info{1},'MeanBefore')
                            text(-.95,dlg.plothistinfo2*.25-min(dlg.plothistinfo2,dlg.plothistinfo3-dlg.plothistinfo2)*.15,{sprintf('mean=%.2f std=%.2f',mean(cellfun(@(x)x.MeanAfter,dlg.results_info)),mean(cellfun(@(x)x.StdAfter,dlg.results_info)))},'horizontalalignment','left','fontsize',5+font_offset,'parent',dlg.handles.hax);
