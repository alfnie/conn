...
%                 end
    ...
    if isempty(handle), % creates new menu entry
        ...
        params=struct(...
            ...
            'color',1/6*.75+.25*[2 2.1 2.2;2 2.1 2.2;-1 5 10]/6,...       % 3x3 matrix of color components. Rows are status (cursor-out,cursor-in,selected) and columns are rgb components
