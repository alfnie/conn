...
if isempty(dataset_to)||isempty(dataset_from)
    ...
    hfig=conn_figure('units','norm','position',[.1,.3,.4,.3],'numbertitle','off','name','Move/Exchange datasets','menubar','none','color','w');
