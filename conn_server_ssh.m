...
switch(lower(option))
    ...
    case {'start','startwithgui','restart'} % init server remotely and connect to it
        ...
        if startwithgui, 
            ...
            uicontrol('style','text','units','norm','position',[.1 .70 .37 .15],'string','Remote server address:','backgroundcolor','w','horizontalalignment','right','parent',h.hfig);
            ...
            uicontrol('style','text','units','norm','position',[.1 .50 .37 .15],'string','Username:','backgroundcolor','w','horizontalalignment','right','parent',h.hfig);
            ...
            uicontrol('style','text','units','norm','position',[.1 .30 .37 .15],'string','Authentication method:','backgroundcolor','w','horizontalalignment','right','parent',h.hfig);
